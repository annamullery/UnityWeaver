 ...
 * This file demonstrates how to integrate Unityweaver with a web frontend
 */

// For React/Vue/Angular applications
export class UnityweaverClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new UnityweaverClient(provider, contractAddress);
