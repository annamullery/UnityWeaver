...
const contractABI = require("../artifacts/contracts/Unityweaver.sol/Unityweaver.json").abi;

program
    .name("unityweaver-cli")
    .description("CLI tool for Unityweaver smart contract")
    .version("1.0.0");
